...
#     Value = $source_server
# }
# $managed_environment_name = "managedEnvironment-rgtest-b676"
...
# $container_app_template = New-AzContainerAppTemplateObject -Name $container_guid -Image "kingmoh/extract_and_load:v3" -ResourceCpu 2.0 -ResourceMemory 4.0Gi -Env @($source_server_env)
...
#     ManagedEnvironmentId = $container_app_managed_env_id
#     TemplateContainer = $container_app_template
# }
...
$templateFile = "/Users/kingmoh/Desktop/Azure-SQL-CICD/local_durable_ps_function/template.json"
$parameterFile = "/Users/kingmoh/Desktop/Azure-SQL-CICD/local_durable_ps_function/parameters.json"
